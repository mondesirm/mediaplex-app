  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: MyTheme.appBar(
      ...
      bottom: TabBar(
        controller: _tab,
        tabs: const [
          Tab(text: 'General',  icon: Icon(Icons.info, color: Colors.blue)),
          Tab(text: 'My Media', icon: Icon(Icons.video_library_rounded, color: Colors.blue))
        ]
      ),
    ...
    body: TabBarView(
      ...
      children: [
        ...
        Container(
          padding: const EdgeInsets.all(10),
          decoration: MyTheme.boxDecoration(),
          child: Center(child: MyTheme.loadingAnimation())
        )
      ]
    )
  );
